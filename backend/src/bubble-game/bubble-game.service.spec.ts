...
jest.mock('./validation/game-core-replay-validator', () => ({
  REPLAY_VERSION: 1,
  validateReplay: jest.fn(),
}));

const validateReplayMock = jest.mocked(validateReplay);
...
describe('BubbleGameService', () => {
  ...
  describe('submitScore', () => {
    ...
    it('rejects an event for an object not generated by the session seed', async () => {
      ...
      validateReplayMock.mockRejectedValueOnce(
        new Error('tap does not match declared object'),
      );
